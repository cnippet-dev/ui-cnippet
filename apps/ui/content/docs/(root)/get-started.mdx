...
This guide provides the essentials for adding **cnippet ui** components to your React application.
...
You can install all **cnippet ui** primitives at once with a single command:
...
Components are styled with the design token system we use at **blocks.cnippet.dev**, which is defined by CSS variables and implemented with Tailwind CSS.
