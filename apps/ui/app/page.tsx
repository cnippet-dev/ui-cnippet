...
//           <div>
//             <div className="">
//               <div className="absolute inset-0 z-0 flex-none overflow-hidden bg-neutral-200 [-webkit-mask:url(https://framerusercontent.com/images/0RjNkZYilrHi1gaLamPLmApzh4.svg)_alpha_repeat_top/31px_31px_add] [mask:url(https://framerusercontent.com/images/0RjNkZYilrHi1gaLamPLmApzh4.svg)_alpha_repeat_top/31px_31px_add] dark:bg-neutral-800" />
...
//                   <Button
//                     className="mx-auto w-fit rounded-full border-blue-600 bg-blue-600 px-6 py-2.5 text-white hover:bg-blue-700 sm:w-auto"
...
//           that reuse Cnippet UI primitives. Hero sections, pricing tables,
//           dashboards, authentication flows, and more — all customizable
//           with Tailwind.
//         </p>
//       </div>
  ...
  return (
    <div>
      <div className="mx-auto max-w-3xl px-6">
        <div className="relative z-20 grid grid-cols-4 items-center justify-center gap-px divide-x divide-foreground/8 border-foreground/8 border-x *:h-12 dark:divide-foreground/10 dark:border-foreground/10">
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex h-8 w-full items-center justify-center gap-1.5 rounded-none px-3 text-xs ring-1 transition-all duration-150 hover:text-foreground group-active:scale-[0.98] [&>svg]:size-3.5 ${
                    isActive
                      ? "bg-foreground/4 text-foreground shadow-black/4 shadow-sm ring-foreground/8 dark:bg-foreground/6 dark:ring-foreground/10"
                      : "text-muted-foreground ring-foreground/8 group-hover:bg-foreground/5 dark:ring-foreground/10"
                  }`}
                >
                  <Icon />
...
export default async function HeroTabsDashboard({
  subtitle = "One platform for your entire team to plan, build, and iterate. From ideation to deployment, Ruixen keeps everything in sync.",
  primaryCtaText = "Get Started Free",
  primaryCtaHref = "#",
  secondaryCtaText = "Request a Demo",
  secondaryCtaHref = "#",
  tabs = defaultTabs,
}: HeroTabsDashboardProps) {
  ...
  return (
    <ReactLenis root>
      ...
      <main className="dark:bg-sidebar">
        <div className="relative px-4 pt-4 md:px-0">
            ...
            <div className="relative mx-auto max-w-6xl overflow-hidden border-x px-4 py-12 sm:px-6 md:py-16 lg:px-8">
              <div className="space-y-6">
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="max-w-3xl text-muted-foreground text-sm leading-relaxed sm:text-base">
                    Pre-built sections, full pages, and production-ready
                    templates that reuse Cnippet UI primitives. Hero sections,
                    pricing tables, dashboards, authentication flows, and more —
