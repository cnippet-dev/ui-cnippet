...
const Components = () => {
  return (
    <>
      <section className="relative w-full px-4 pb-16 sm:px-8 sm:pb-20 md:px-10">
        <div className="">
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-5 pt-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      ...
      <section className="relative w-full px-4 pb-16 sm:px-8 sm:py-20 md:px-10">
        <div className="">
          <div className="mx-auto max-w-6xl">
            <motion.h2
              {...fadeUp({
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 pt-10 md:grid-cols-12 md:gap-4">
