        ...
        <div className="relative z-10">
          <div className="mx-auto flex max-w-5xl flex-col items-center justify-center px-6 py-32 text-center">
            <motion.h1
              ...
              className="font-medium mb-6 max-w-full text-4xl tracking-tight leading-tight text-gray-900 md:text-6xl lg:text-5xl dark:text-gray-100"
            >
              Build faster with production-ready{" "}
              <motion.span
                {...zoomIn({ delay: 0.1, duration: 0.5 })}
                className="relative mt-2 inline-flex items-center border border-dashed px-4"
              >
                <div
            ...
            >
              Production-ready React components, animations, and charts to ship
              your next project faster. Perfect for{" "}
              <motion.span
