...
import useScreenSize from "@/hooks/use-size-size"
...
export default function BoxCarouselDemo() {
  ...
  return (
    <div className="w-full max-w-xl h-full p-6 flex justify-items-center justify-center items-center text-muted-foreground bg-[#fefefe]">
      <button
        onClick={toggleDebug}
