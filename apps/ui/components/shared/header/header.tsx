...
export function SiteHeader({
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-sidebar/80 backdrop-blur-sm before:absolute before:inset-x-0 before:bottom-0 mx-auto max-w-[94.6%] before:h-px before:bg-border/50">
