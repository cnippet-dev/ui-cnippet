...
export function SiteHeader({
  ...
  return (
    <header className="sticky top-0 z-10 mx-auto w-full max-w-[94.6%] bg-sidebar/80 backdrop-blur-sm before:absolute before:inset-x-0 before:bottom-0 before:h-px before:bg-border/50">
