    ...
    <ToggleGroupPrimitive
      className={cn(
        ...
        variant === "default"
          ? "gap-0.5"
          : orientation === "horizontal"
            ? "*:not-first:rounded-s-none *:not-last:rounded-e-none *:not-first:border-s-0 *:not-last:border-e-0 *:not-first:before:-inset-s-[0.5px] *:not-last:before:-inset-e-[0.5px] *:not-first:before:rounded-s-none *:not-last:before:rounded-e-none"
