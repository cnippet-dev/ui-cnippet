...
function rewriteImports(code: string): string {
  ...
  // "@/lib/*"        → "@cnippet/lib/*"
  // "@/hooks/*"      → "@cnippet/hooks/*"
  // "@/registry/default/ui/*" → "@cnippet/ui/*"
  // "@/registry/default/hooks/*" → "@cnippet/hooks/*"
  // "@/registry/default/lib/*" → "@cnippet/lib/*"
  result = result.replace(/(["'])@\/lib\//g, "$1@cnippet/lib/");
  result = result.replace(/(["'])@\/hooks\//g, "$1@cnippet/hooks/");
