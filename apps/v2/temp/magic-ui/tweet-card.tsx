...
export const TweetBody = ({ tweet }: { tweet: EnrichedTweet }) => (
  <div className="wrap-break-word text-[15px] leading-relaxed tracking-normal">
    {tweet.entities.map((entity, idx) => {
      switch (entity.type) {
        ...
        case "mention":
          return (
            <a
              className="font-normal text-[15px] text-muted-foreground transition-colors hover:text-foreground"
              href={entity.href}
              key={idx}
        ...
        case "text":
          return (
            <span
              className="font-normal text-[15px] text-foreground"
